# Indoor Asset Tracking Template
...
## Setup
To begin using this template, enable the [Device Simulator](/applications/~losant-application-devApplicationIndoorAssetTracking-0~/workflows/~losant-flow-workflowDeviceSimulator-0~/develop) workflow and the [Event Alerting](/applications/~losant-application-devApplicationIndoorAssetTracking-0~/workflows/~losant-flow-workflowEventAlerting-3~/develop) workflow.
...
- [Equipment Device Recipe](/applications/~losant-application-devApplicationIndoorAssetTracking-0~/device-recipes/~losant-deviceRecipe-equipmentDevice-0~/properties)
- [Person Device Recipe](/applications/~losant-application-devApplicationIndoorAssetTracking-0~/device-recipes/~losant-deviceRecipe-personDevice-1~/properties)
